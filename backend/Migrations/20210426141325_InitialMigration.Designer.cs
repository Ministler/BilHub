...
namespace BilHub.Migrations
{
    ...
    [Migration("20210426141325_InitialMigration")]
            ...
            modelBuilder.Entity("backend.Models.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 26, 17, 13, 24, 881, DateTimeKind.Local).AddTicks(9761),
                        ...
                        new
                        {
                            ...
                            CanBeGradedByStudents = true,
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 26, 17, 13, 24, 883, DateTimeKind.Local).AddTicks(3603),
                            DueDate = new DateTime(2021, 4, 15, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            IsItGraded = true,
                            MaxFileSizeInBytes = 4096,
                            VisibilityOfSubmission = true
                        ...
                        new
                        {
                            ...
                            CanBeGradedByStudents = true,
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 26, 17, 13, 24, 888, DateTimeKind.Local).AddTicks(6689),
                        ...
                        new
                        {
                            ...
                            CourseId = 2,
                            CreatedAt = new DateTime(2021, 4, 26, 17, 13, 24, 888, DateTimeKind.Local).AddTicks(6712),
                            DueDate = new DateTime(2021, 5, 15, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            IsItGraded = false,
                            MaxFileSizeInBytes = 1024,
            ...
            modelBuilder.Entity("backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CommentedUserId = 2,
                            CreatedAt = new DateTime(2021, 4, 26, 17, 13, 24, 885, DateTimeKind.Local).AddTicks(3744),
            ...
            modelBuilder.Entity("backend.Models.Submission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HasSubmission = false,
                            SectionId = 1,
                            UpdatedAt = new DateTime(2021, 4, 26, 17, 13, 24, 884, DateTimeKind.Local).AddTicks(8318)
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "cagri@durgut",
                            Name = "Cagri Durgut",
                            PasswordHash = new byte[] { 88, 171, 70, 24, 138, 166, 189, 130, 198, 49, 254, 149, 215, 223, 122, 30, 44, 137, 93, 214, 100, 143, 172, 131, 117, 93, 135, 255, 215, 2, 192, 174, 213, 2, 214, 129, 121, 211, 33, 102, 245, 183, 14, 5, 175, 29, 17, 130, 216, 179, 90, 89, 183, 79, 164, 158, 122, 76, 228, 70, 36, 22, 87, 204 },
                            PasswordSalt = new byte[] { 174, 171, 123, 132, 187, 3, 75, 252, 192, 124, 104, 89, 51, 182, 200, 89, 156, 24, 97, 224, 177, 177, 231, 50, 46, 67, 11, 36, 26, 17, 76, 240, 110, 192, 166, 2, 25, 186, 57, 53, 242, 187, 49, 183, 249, 59, 114, 11, 2, 108, 24, 189, 189, 36, 47, 137, 136, 31, 153, 47, 54, 222, 85, 255, 202, 70, 111, 163, 110, 86, 23, 8, 173, 74, 207, 133, 41, 93, 148, 175, 46, 213, 182, 107, 89, 122, 28, 2, 56, 137, 193, 117, 191, 135, 122, 159, 180, 242, 28, 59, 69, 131, 84, 70, 158, 240, 220, 93, 216, 225, 246, 8, 187, 139, 86, 154, 70, 102, 104, 118, 250, 92, 195, 96, 123, 151, 63, 178 },
                            SecondPasswordHash = new byte[] { 88, 171, 70, 24, 138, 166, 189, 130, 198, 49, 254, 149, 215, 223, 122, 30, 44, 137, 93, 214, 100, 143, 172, 131, 117, 93, 135, 255, 215, 2, 192, 174, 213, 2, 214, 129, 121, 211, 33, 102, 245, 183, 14, 5, 175, 29, 17, 130, 216, 179, 90, 89, 183, 79, 164, 158, 122, 76, 228, 70, 36, 22, 87, 204 },
                            UserType = 0,
                            VerificationCode = "31",
                            VerifiedStatus = true
                        },
