...
namespace BilHub.Migrations
{
    ...
    [Migration("20210426203101_TestMigration2")]
            ...
            modelBuilder.Entity("backend.Models.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 26, 23, 31, 1, 279, DateTimeKind.Local).AddTicks(8293),
                        ...
                        new
                        {
                            ...
                            CourseId = 2,
                            CreatedAt = new DateTime(2021, 4, 26, 23, 31, 1, 279, DateTimeKind.Local).AddTicks(9717),
                            DueDate = new DateTime(2021, 5, 15, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            IsItGraded = false,
                            MaxFileSizeInBytes = 1024,
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "cagri@durgut",
                            Name = "Cagri Durgut",
                            PasswordHash = new byte[] { 29, 59, 35, 98, 137, 9, 26, 112, 22, 2, 96, 220, 66, 223, 14, 44, 207, 25, 61, 124, 61, 1, 129, 14, 247, 89, 15, 186, 208, 194, 191, 253, 253, 168, 0, 250, 147, 71, 72, 164, 174, 49, 88, 147, 185, 252, 149, 0, 111, 91, 5, 72, 97, 166, 76, 92, 107, 101, 118, 78, 110, 252, 231, 58 },
                            PasswordSalt = new byte[] { 162, 60, 53, 17, 41, 72, 194, 113, 229, 127, 237, 55, 143, 174, 29, 192, 57, 48, 53, 69, 202, 6, 150, 242, 5, 117, 189, 115, 79, 39, 54, 93, 150, 204, 165, 105, 226, 132, 57, 120, 125, 132, 142, 218, 120, 161, 69, 251, 154, 128, 242, 39, 224, 32, 37, 218, 95, 240, 98, 212, 95, 191, 204, 23, 28, 27, 120, 188, 203, 193, 63, 110, 186, 154, 140, 115, 173, 126, 190, 161, 53, 67, 23, 139, 144, 113, 60, 13, 28, 137, 53, 228, 117, 160, 45, 231, 61, 4, 78, 114, 43, 85, 249, 146, 138, 153, 126, 91, 222, 222, 53, 185, 112, 18, 114, 158, 0, 154, 2, 201, 253, 215, 109, 254, 42, 229, 90, 7 },
                            SecondPasswordHash = new byte[] { 29, 59, 35, 98, 137, 9, 26, 112, 22, 2, 96, 220, 66, 223, 14, 44, 207, 25, 61, 124, 61, 1, 129, 14, 247, 89, 15, 186, 208, 194, 191, 253, 253, 168, 0, 250, 147, 71, 72, 164, 174, 49, 88, 147, 185, 252, 149, 0, 111, 91, 5, 72, 97, 166, 76, 92, 107, 101, 118, 78, 110, 252, 231, 58 },
                            UserType = 0,
                            VerificationCode = "31",
                            VerifiedStatus = true
                        },
