            ...
            modelBuilder.Entity("backend.Models.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 27, 2, 33, 43, 121, DateTimeKind.Local).AddTicks(8377),
                        ...
                        new
                        {
                            ...
                            CanBeGradedByStudents = true,
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 27, 2, 33, 43, 122, DateTimeKind.Local).AddTicks(4846),
                            DueDate = new DateTime(2021, 4, 15, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            IsItGraded = true,
                            MaxFileSizeInBytes = 4096,
                            VisibilityOfSubmission = true
                        ...
                        new
                        {
                            ...
                            CanBeGradedByStudents = true,
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 27, 2, 33, 43, 124, DateTimeKind.Local).AddTicks(8374),
                        ...
                        new
                        {
                            ...
                            CourseId = 2,
                            CreatedAt = new DateTime(2021, 4, 27, 2, 33, 43, 124, DateTimeKind.Local).AddTicks(8380),
                            DueDate = new DateTime(2021, 5, 15, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            IsItGraded = false,
                            MaxFileSizeInBytes = 1024,
            ...
            modelBuilder.Entity("backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CommentedUserId = 2,
                            CreatedAt = new DateTime(2021, 4, 27, 2, 33, 43, 123, DateTimeKind.Local).AddTicks(4903),
            ...
            modelBuilder.Entity("backend.Models.Submission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HasSubmission = false,
                            SectionId = 1,
                            UpdatedAt = new DateTime(2021, 4, 27, 2, 33, 43, 123, DateTimeKind.Local).AddTicks(2811)
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "cagri@durgut",
                            Name = "Cagri Durgut",
                            PasswordHash = new byte[] { 218, 217, 131, 109, 156, 57, 148, 7, 48, 82, 163, 103, 46, 96, 110, 132, 171, 234, 182, 133, 196, 221, 58, 110, 198, 190, 112, 73, 15, 224, 229, 57, 131, 177, 39, 63, 189, 168, 37, 142, 224, 182, 27, 173, 240, 166, 171, 43, 151, 153, 223, 49, 22, 236, 247, 15, 90, 72, 167, 247, 7, 145, 227, 127 },
                            PasswordSalt = new byte[] { 197, 132, 163, 99, 95, 135, 101, 140, 152, 251, 90, 9, 127, 86, 9, 11, 128, 62, 104, 108, 186, 205, 185, 74, 199, 36, 16, 138, 216, 131, 120, 172, 125, 15, 141, 6, 7, 43, 106, 246, 145, 36, 209, 24, 136, 220, 132, 125, 132, 237, 137, 157, 206, 83, 88, 126, 67, 167, 49, 55, 92, 37, 146, 46, 93, 54, 79, 171, 199, 173, 43, 237, 141, 240, 82, 207, 125, 101, 158, 190, 216, 19, 167, 156, 252, 99, 97, 253, 42, 160, 248, 191, 175, 16, 202, 35, 231, 64, 110, 143, 141, 171, 162, 13, 90, 87, 118, 71, 231, 73, 134, 142, 19, 82, 82, 102, 179, 58, 184, 97, 108, 91, 239, 74, 48, 212, 243, 219 },
                            SecondPasswordHash = new byte[] { 218, 217, 131, 109, 156, 57, 148, 7, 48, 82, 163, 103, 46, 96, 110, 132, 171, 234, 182, 133, 196, 221, 58, 110, 198, 190, 112, 73, 15, 224, 229, 57, 131, 177, 39, 63, 189, 168, 37, 142, 224, 182, 27, 173, 240, 166, 171, 43, 151, 153, 223, 49, 22, 236, 247, 15, 90, 72, 167, 247, 7, 145, 227, 127 },
                            UserType = 0,
                            VerificationCode = "31",
                            VerifiedStatus = true
                        },
