            ...
            modelBuilder.Entity("backend.Models.Assignment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 27, 1, 12, 16, 882, DateTimeKind.Local).AddTicks(1672),
                        ...
                        new
                        {
                            ...
                            CanBeGradedByStudents = true,
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 27, 1, 12, 16, 883, DateTimeKind.Local).AddTicks(1618),
                            DueDate = new DateTime(2021, 4, 15, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            IsItGraded = true,
                            MaxFileSizeInBytes = 4096,
                            VisibilityOfSubmission = true
                        ...
                        new
                        {
                            ...
                            CanBeGradedByStudents = true,
                            CourseId = 1,
                            CreatedAt = new DateTime(2021, 4, 27, 1, 12, 16, 886, DateTimeKind.Local).AddTicks(4750),
                        ...
                        new
                        {
                            ...
                            CourseId = 2,
                            CreatedAt = new DateTime(2021, 4, 27, 1, 12, 16, 886, DateTimeKind.Local).AddTicks(4759),
                            DueDate = new DateTime(2021, 5, 15, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            IsItGraded = false,
                            MaxFileSizeInBytes = 1024,
            ...
            modelBuilder.Entity("backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CommentedUserId = 2,
                            CreatedAt = new DateTime(2021, 4, 27, 1, 12, 16, 884, DateTimeKind.Local).AddTicks(6113),
            ...
            modelBuilder.Entity("backend.Models.Submission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HasSubmission = false,
                            SectionId = 1,
                            UpdatedAt = new DateTime(2021, 4, 27, 1, 12, 16, 884, DateTimeKind.Local).AddTicks(3763)
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "cagri@durgut",
                            Name = "Cagri Durgut",
                            PasswordHash = new byte[] { 200, 169, 178, 206, 254, 155, 114, 103, 12, 107, 166, 90, 51, 73, 219, 153, 30, 187, 32, 186, 211, 78, 165, 167, 39, 111, 38, 198, 174, 24, 176, 17, 138, 223, 31, 51, 141, 234, 248, 212, 223, 233, 65, 238, 132, 30, 127, 242, 79, 143, 213, 55, 39, 197, 117, 130, 14, 246, 79, 67, 82, 219, 127, 176 },
                            PasswordSalt = new byte[] { 136, 71, 198, 175, 194, 249, 214, 155, 213, 112, 27, 133, 137, 182, 74, 97, 1, 133, 25, 11, 38, 169, 207, 146, 52, 74, 126, 69, 189, 237, 210, 155, 35, 234, 181, 45, 218, 246, 47, 168, 40, 39, 102, 96, 52, 148, 22, 147, 3, 214, 189, 91, 208, 82, 113, 237, 26, 133, 59, 13, 153, 137, 101, 86, 156, 26, 147, 45, 109, 35, 165, 178, 199, 101, 150, 99, 153, 255, 88, 167, 207, 3, 185, 188, 185, 164, 112, 216, 103, 152, 205, 172, 98, 214, 78, 153, 56, 56, 73, 95, 179, 87, 40, 133, 16, 133, 37, 152, 211, 167, 166, 80, 156, 115, 57, 15, 61, 64, 13, 111, 188, 116, 14, 52, 221, 69, 31, 239 },
                            SecondPasswordHash = new byte[] { 200, 169, 178, 206, 254, 155, 114, 103, 12, 107, 166, 90, 51, 73, 219, 153, 30, 187, 32, 186, 211, 78, 165, 167, 39, 111, 38, 198, 174, 24, 176, 17, 138, 223, 31, 51, 141, 234, 248, 212, 223, 233, 65, 238, 132, 30, 127, 242, 79, 143, 213, 55, 39, 197, 117, 130, 14, 246, 79, 67, 82, 219, 127, 176 },
                            UserType = 0,
                            VerificationCode = "31",
                            VerifiedStatus = true
                        },
