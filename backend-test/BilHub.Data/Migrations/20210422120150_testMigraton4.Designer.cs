...
namespace BilHub.Data.Migrations
{
    ...
    [Migration("20210422120150_testMigraton4")]
    partial class testMigraton4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BilHub.Core.Models.GroupSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BilHub.Core.Models.PeerGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BilHub.Core.Models.StudentMergeRequest", b =>
                {
                    ...
                    b.ToTable("StudentMergeRequests");
                });
            ...
            modelBuilder.Entity("BilHub.Core.Models.StudentProjectGroup", b =>
                {
                    ...
                    b.ToTable("StudentProjectGroups");
                });
            ...
            modelBuilder.Entity("BilHub.Core.Models.UnvotedJoinRequest", b =>
                {
                    b.Property<int>("StudentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BilHub.Core.Models.PeerGrade", b =>
                {
                    b.HasOne("BilHub.Core.Models.Student", "Reviewee")
                        .WithMany()
                        .HasForeignKey("RevieweeId");

                    b.HasOne("BilHub.Core.Models.Student", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("BilHub.Core.Models.Student", b =>
                {
                    ...
                    b.Navigation("UnvotedJoinRequests");
